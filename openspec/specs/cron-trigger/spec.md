...
Déclenchement sécurisé et fiable du job de scraping nocturne via un endpoint HTTP interne. Protège contre les exécutions non autorisées et les double-déclenchements.
