...
Scraping de WIK Nantes (`https://www.wik-nantes.fr/agenda`) via la page listing paginée. Les données collectées sont titre, date, lieu, image et catégorie. Les descriptions sont enrichies via une deuxième passe sur les pages détail.
